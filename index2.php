				...
				<div class="wrapper style2">
					...
					<article id="main" class="container special">
						...
						<?php getLocalizedStringForKey("reservations.p2"); ?>
							...
							<div class="pricelist">
							<table width="80%"  border="1" class="pricelist">
								<thead class="pricelist">
									<tr>
										<th width="25%"></th>
										<th width="25%">Mas de Vignal (incl. gîte)</th>
										<th width="25%">Mas de Vignal (excl. gîte)</th>
										<th width="25%">Gîte</th>
									</tr>
								</thead>
								<tbody>
								<tr>
									<td>3/1/2021 - 4/4/2021</td>
									<td>1550,00 € / <?php getLocalizedStringForKey("pricelist.week"); ?></td>
									<td>1150,00 € / <?php getLocalizedStringForKey("pricelist.week"); ?></td>
									<td>450,00 € / <?php getLocalizedStringForKey("pricelist.week"); ?></td>
								</tr>
								<tr>
									<td>4/4/2021 - 18/4/2021</td>
									<td>1990,00 € / <?php getLocalizedStringForKey("pricelist.week"); ?></td>
									<td>1550,00 € / <?php getLocalizedStringForKey("pricelist.week"); ?></td>
									<td>490,00 € / <?php getLocalizedStringForKey("pricelist.week"); ?></td>
								</tr>
								<tr>
									<td>18/4/2021 - 2/5/2021</td>
									<td>1550,00 € / <?php getLocalizedStringForKey("pricelist.week"); ?></td>
									<td>1150,00 € / <?php getLocalizedStringForKey("pricelist.week"); ?></td>
									<td>450,00 € / <?php getLocalizedStringForKey("pricelist.week"); ?></td>
								</tr>
								<tr>
									<td>2/5/2021 - 4/7/2021</td>
									<td>1990,00 € / <?php getLocalizedStringForKey("pricelist.week"); ?></td>
									<td>1550,00 € / <?php getLocalizedStringForKey("pricelist.week"); ?></td>
									<td>490,00 € / <?php getLocalizedStringForKey("pricelist.week"); ?></td>
								</tr>
								<tr>
									<td>4/7/2021 - 29/8/2021</td>
									<td>3300,00 € / <?php getLocalizedStringForKey("pricelist.week"); ?></td>
									<td class="disabled"></td>
									<td class="disabled"></td>
								</tr>
								<tr>
									<td>29/8/2021 - 26/9/2021</td>
									<td>1990,00 € / <?php getLocalizedStringForKey("pricelist.week"); ?></td>
									<td>1550,00 € / <?php getLocalizedStringForKey("pricelist.week"); ?></td>
									<td>490,00 € / <?php getLocalizedStringForKey("pricelist.week"); ?></td>
								</tr>
								<tr>
									<td>26/9/2021 - 2/1/2022</td>
									<td>1550,00 € / <?php getLocalizedStringForKey("pricelist.week"); ?></td>
									<td>1150,00 € / <?php getLocalizedStringForKey("pricelist.week"); ?></td>
									<td>450,00 € / <?php getLocalizedStringForKey("pricelist.week"); ?></td>
								</tr>
						...
						<div class="row" ><br />
							...
							<div id="calendar2">
								<?php include('php/calendar2.php'); ?>
							</div>
							</article>
							<article class='4u 12u(mobile) special'>
								<div style="text-align:center;">Gîte</div>
							<div id="calendar3">
								<?php include('php/calendar3.php'); ?>
							</div>
							</article>
						</div>
